...
%GETSIMPLIFIEDSCHEDULERIDSFORJOB Returns the smallest possible list of LSF job IDs that describe the MATLAB job.
%
% SCHEDULERIDS = getSimplifiedSchedulerIDsForJob(JOB) returns the smallest
% possible list of LSF job IDs that describe the MATLAB job JOB. The
